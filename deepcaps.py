...
#     l = Dropout(0.4)(l)
    ...
    decoder.add(BatchNormalization(momentum=0.8))
    decoder.add(Deconvolution2D(64, (3, 3), strides=(1, 1), padding='same'))
    decoder.add(Deconvolution2D(32, (3, 3), strides=(2, 2), padding='same'))
    decoder.add(Deconvolution2D(16, (3, 3), strides=(2, 2), padding='same'))
    decoder.add(Deconvolution2D(1, (3, 3), strides=(1, 1), padding='same'))
    decoder.add(Activation("relu"))
